...
var _class,
    ...
    _class3,
    _temp,
    _jsxFileName = "/Users/jarezvani/workspace/react-widgets/packages/react-widgets/src/Combobox.js";
...
function (_React$Component) {
  ...
  Combobox.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    ...
    var nextFocusedItem = focusedIndex === -1 ? focusedItem : data[focusedIndex];
    return {
      data: data,
      list: list,
      accessors: accessors,
